...
class MyApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      home: AugustPage(title:'8月'),
    );
  }
}

class AugustPage extends StatefulWidget {
  AugustPage({Key? key,required this.title}) : super(key:key);
...
class _MyHomePageState extends State<AugustPage> {
  bool seletincome=false;


  void changeBackground() {
    setState(() {
      backgroundnum8 = (backgroundnum8 + 1) % backgrounds.length;
    });
  }
  ...
  void _removeItem(int index) {
    ...
    setState(() {
      Map<String, dynamic> item = items8[index];
      int a1=item['amount'];
      if (item['isIncome']) {
        income8 -= a1;
        total_income-=a1;
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body:Container(
        decoration: backgrounds[backgroundnum8],
        child:Column(
          children: [
            ...
            Container(
              ...
              child: Column(
                ...
                children: [
                  ...
                  Text('\$$asset8',style: TextStyle(color: Colors.white,fontSize: 30),),
                  Padding(
