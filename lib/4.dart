...
class MyApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      home: AprilPage(title:'4月'),
    );
  }
}

class AprilPage extends StatefulWidget {
  AprilPage({Key? key,required this.title}) : super(key:key);
...
class _MyHomePageState extends State<AprilPage> {
  ...
  void changeBackground() {
    setState(() {
      backgroundnum4 = (backgroundnum4 + 1) % backgrounds.length;
    });
  }
  ...
  void _removeItem(int index) {
    ...
    setState(() {
      Map<String, dynamic> item = items4[index];
      int a1=item['amount'];
      if (item['isIncome']) {
        income4 -= a1;
        total_income-=a1;
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body:Container(
        decoration: backgrounds[backgroundnum4],
        child:Column(
          children: [
            ...
            Container(
              ...
              child: Column(
                ...
                children: [
                  ...
                  Text('\$$asset4',style: TextStyle(color: Colors.white,fontSize: 30),),
                  Padding(
