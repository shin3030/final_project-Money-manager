...
class MyApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      home: OctoberPage(title:'10月'),
    );
  }
}

class OctoberPage extends StatefulWidget {
  OctoberPage({Key? key,required this.title}) : super(key:key);
...
class _MyHomePageState extends State<OctoberPage> {
  bool seletincome=false;


  void changeBackground() {
    setState(() {
      backgroundnum10 = (backgroundnum10 + 1) % backgrounds.length;
    });
  }
  ...
  void _removeItem(int index) {
    ...
    setState(() {
      Map<String, dynamic> item = items10[index];
      int a1=item['amount'];
      if (item['isIncome']) {
        income10 -= a1;
        total_income-=a1;
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body:Container(
        decoration: backgrounds[backgroundnum10],
        child:Column(
          children: [
            ...
            Container(
              ...
              child: Column(
                ...
                children: [
                  ...
                  Text('\$$asset10',style: TextStyle(color: Colors.white,fontSize: 30),),
                  Padding(
