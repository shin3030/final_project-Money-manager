...
class MyApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      home: MayPage(title:'5月'),
    );
  }
}

class MayPage extends StatefulWidget {
  MayPage({Key? key,required this.title}) : super(key:key);
...
class _MyHomePageState extends State<MayPage> {
  ...
  void changeBackground() {
    setState(() {
      backgroundnum5 = (backgroundnum5 + 1) % backgrounds.length;
    });
  }
  ...
  void _removeItem(int index) {
    ...
    setState(() {
      Map<String, dynamic> item = items5[index];
      int a1=item['amount'];
      if (item['isIncome']) {
        income5 -= a1;
        total_income-=a1;
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body:Container(
        decoration: backgrounds[backgroundnum5],
        child:Column(
          children: [
            ...
            Container(
              ...
              child: Column(
                ...
                children: [
                  ...
                  Text('\$$asset5',style: TextStyle(color: Colors.white,fontSize: 30),),
                  Padding(
